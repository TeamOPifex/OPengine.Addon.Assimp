  ...
  message(STATUS "ASSIMP RELEASE MODE ${OPIFEX_OPTION_RELEASE}")
    if(${OPIFEX_OS_WIN64})
        if(${OPIFEX_OPTION_RELEASE})
            ...
            SET(assimp_lib "${ASSIMP_PATH}/bin/win64/release/assimp-vc140-mt.lib")
            SET(assimp_dll "${ASSIMP_PATH}/bin/win64/release/assimp-vc140-mt.dll")
        else()
            SET(BINARY_RELEASE_MODE "debug")
            SET(assimp_lib "${ASSIMP_PATH}/bin/win64/debug/assimp-vc140-mt.lib")
            SET(assimp_dll "${ASSIMP_PATH}/bin/win64/debug/assimp-vc140-mt.dll")
